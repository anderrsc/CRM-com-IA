...
const maps = {
  ...
  budgets: {
    ...
    toDb: (item) => ({
      ...
      lead_id: valueOrNull(item.leadId),
      lead_name: item.leadName || '',
      quote_type: valueOrNull(item.quoteType),
      items: item.items || [],
  ...
  quoteSettings: {
    ...
    toApp: (row) => ({
      ...
      showQrCode: valueOrDefault(row.show_qr_code, true),
      showSignature: valueOrDefault(row.show_signature, true),
    ...
    toDb: (item) => ({
      ...
      logo_url: valueOrNull(item.logoUrl),
      phone: valueOrNull(item.phone),
      email: valueOrNull(item.email),
      header_text: item.headerText || '',
      footer_text: item.footerText || '',
      pix_key: valueOrNull(item.pixKey),
      accent_color: item.accentColor || '#b91c1c',
      secondary_color: item.secondaryColor || '#111827',
      font_family: item.fontFamily || 'Arial',
      layout_style: item.layoutStyle || 'moderno',
      watermark_text: valueOrNull(item.watermarkText),
      show_qr_code: valueOrDefault(item.showQrCode, true),
      show_signature: valueOrDefault(item.showSignature, true),
  ...
  purchases: {
    ...
    toDb: (item) => ({
      ...
      total: item.total || 0,
      payment_method: item.paymentMethod || 'outro',
      purchased_by: item.purchasedBy || '',
      purchased_at: item.purchasedAt || new Date().toISOString(),
      expected_at: valueOrNull(item.expectedAt),
      received_at: valueOrNull(item.receivedAt),
      status: item.status || 'comprado',
      notes: valueOrNull(item.notes),
      created_at: item.createdAt || new Date().toISOString(),
      updated_at: item.updatedAt || new Date().toISOString(),
    }),
